...
2. specify 단계 → `spec.md` 산출 → 🚦 GATE 1 (Phase 1a — 메인 컨텍스트가 사용자 확인)
3. 승인 후 plan 단계 → `plan.md` 산출 → 🚦 GATE 2 (Phase 1b — 사용자 확인)
4. 승인 후 tasks 단계 → `tasks.md` 산출 → 🚦 GATE 3 (Phase 1c — 사용자 확인, **BLOCKING · 필수**)
