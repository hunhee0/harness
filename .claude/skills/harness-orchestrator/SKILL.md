...
1. `docs/spec/` 존재 여부 확인
2. 진행 중인 feature가 있으면 해당 `tasks.md` 읽기
3. 상태 분류 후 진입점 결정:

| 상태 | 조건 | 진입점 |
|------|------|--------|
| **신규** | `docs/spec/` 없거나 해당 feature 폴더 없음 | Phase 1 |
...
[OUTPUT] docs/spec/{feature}/tasks.md 완성
[CONSTRAINT]
...
[INPUT] docs/spec/{feature}/tasks.md + spec.md
...
```
[GOAL] 스펙 준수 + 코드 품질 검증
[INPUT] 구현 파일 목록 + docs/spec/{feature}/spec.md
